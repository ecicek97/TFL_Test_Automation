...
import { TestData, getStationInfo } from '../support/test-data';

Given('I am on the TfL Journey Planner page', async function (this: CustomWorld) {
  await this.journeyPage.navigate();
});

When('I plan a journey from {string} to {string} using autocomplete suggestions',
  async function (this: CustomWorld, from: string, to: string) {
...
When('I enter invalid locations and plan a journey', async function (this: CustomWorld) {
...
When('I attempt to plan a journey without entering any locations', async function (this: CustomWorld) {
  await this.journeyPage.clickPlanJourney();
});
...
Then('I should see journey results', async function (this: CustomWorld) {
...
Then('the results should display walking time', async function (this: CustomWorld) {
...
Then('the results should display cycling time', async function (this: CustomWorld) {
...
Then('I should see updated journey results', async function (this: CustomWorld) {
...
Then('the journey time should be displayed', async function (this: CustomWorld) {
...
Then('I should see complete access information for Covent Garden Underground Station', async function (this: CustomWorld) {
...
Then('I should not see valid journey results', async function (this: CustomWorld) {
  const noResults = await this.journeyPage.hasNoValidResults();
  expect(noResults, 'Expected no valid journey results').toBeTruthy();
});

Then('I should see an error or no results message', async function (this: CustomWorld) {
...
Then('the widget should not plan a journey', async function (this: CustomWorld) {
...
Then('the journey plan form should remain visible', async function (this: CustomWorld) {
